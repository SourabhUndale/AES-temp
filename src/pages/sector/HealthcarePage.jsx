...
const solutions = [
  {
    icon: "🔧",
    title: "Application-Specific Hardware Design",
    desc: "We design embedded hardware specifically for your medical device — sensor interfacing, signal conditioning, power isolation, and I/O engineered to your exact application.",
    img: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=80"
  },
  {
    icon: "⏱️",
    title: "Firmware for Real-Time Medical Control",
    desc: "Medical devices cannot tolerate latency or unpredictable behaviour. Our firmware delivers deterministic, real-time performance with alarm management and fail-safe logic from day one.",
    img: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&q=80"
  },
  {
    icon: "✅",
    title: "Proven Track Record in Critical Medical Applications",
    desc: "We have designed Adult, Neonatal, and HFOV Ventilators - including a patented HFOV apparatus (Patent No. 542763). We have built baby warmers tested to IEC 60601-1-2 with ESD, EFT, and surge compliance.",
    img: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&q=80"
  },
  {
    icon: "🏅",
    title: "ISO 13485:2016 Certified Process",
    desc: "Our QMS is ISO 13485:2016 certified. Documentation, design controls, traceability, and testing processes are all aligned with what medical device regulators expect.",
    img: "https://images.unsplash.com/photo-1582719508461-905c673771fd?w=600&q=80"
  }
];

const problems = [
  { icon: "⚡", title: "Off-the-shelf modules fail in clinical settings", desc: "Generic embedded modules weren't designed for hospital EMC environments. They fail interference tests and don't interface cleanly with specialized medical sensors." },
  { icon: "🎯", title: "Standard PLCs lack medical-grade precision", desc: "Patient monitoring, drug delivery, and respiratory support demand low-latency, deterministic control. General-purpose boards simply weren't built to that standard." },
  { icon: "📋", title: "Regulatory compliance is a design constraint", desc: "IEC 60601-1-2, EMC, ESD, EFT, surge — compliance cannot be added as an afterthought. It must be engineered into the system from schematic to submission." },
  { icon: "🔍", title: "Rare intersection of skills", desc: "Most embedded firms lack compliance experience. Most medical firms lack hardware depth. Finding a partner who commands both is extraordinarily rare." }
];

const trackItems = [
  "Ventilator control systems — Adult, Neonatal, and HFOV models",  
  "Baby warmer embedded controllers with precision temperature regulation",
  "Diagnostic and biomedical equipment embedded systems",
  "Human Milk Pasteurization Machine — India's first, installed at UCLA & KEM Hospital, Pune",
  "Drug infusion and delivery system controllers",
  "Medical-grade HMI and display interface systems",
  "Patented HFOV apparatus (Patent No. 542763)"
];
  ...
  return (
    <div style={{ fontFamily: "'Satoshi', sans-serif", background: "#fff" }}>
      ...
      <div className="hero ">
        ...
        >
          In Healthcare, a Failing Electronic Component Is{" "}
          <em style={{ fontStyle: "normal", color: "#b8c8f5" }}>Never Just a Technical Issue.</em>
        </motion.h1>
        ...
        >
          Medical device OEMs come to AESPL for embedded systems engineered with the same precision and accountability that patient safety demands — every time, in every condition.
        </motion.p>
      ...
      <section className="problems">
        <FadeSection>
          ...
          <h2>Medical Device OEMs Face a Problem Standard Solutions Cannot Fix.</h2>
          <p className="section-desc">Building a medical device is hard. Building the embedded electronics inside it is even harder. Most OEMs face the same deep frustrations.</p>
        </FadeSection>
      ...
      <section className="solutions">
        <FadeSection>
          ...
          <h2>Custom Embedded Electronics, Engineered for the Clinical Environment.</h2>
      ...
      <FadeSection>
        <div className="quote-band">
          <blockquote>
            "Our ventilator systems have supported patients in ICUs. Our milk pasteurizers have nourished premature infants on two continents. That is the level of accountability we carry into every medical project."
          </blockquote>
