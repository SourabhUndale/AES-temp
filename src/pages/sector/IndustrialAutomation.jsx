...
const solutions = [
  {
    icon: "🔧",
    title: "Rugged Hardware Design for Industrial Environments",
    desc: "Our embedded systems are designed from the ground up for industrial-grade reliability — with robust power supply design, opto-isolated I/O, proper grounding architecture, and EMI/EMC hardening built into the hardware, not added as an afterthought. Your controller works correctly in the actual electrical environment of your machine.",
    img: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=80"
  },
  {
    icon: "⏱️",
    title: "Real-Time Control Without PLC Overhead",
    desc: "Custom embedded firmware gives you deterministic, interrupt-driven control that responds faster and more precisely than a PLC scan cycle allows. For applications where timing accuracy matters — motor synchronization, process sequencing, safety interlocks — this is a fundamental performance advantage.",
    img: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&q=80"
  },
  {
    icon: "✅",
    title: "Seamless Machine Integration",
    desc: "We design the I/O architecture, communication interfaces, and sensor integration specifically for your machine — not for a generic set of inputs and outputs that may or may not match your application. The result is a control system that integrates cleanly, behaves predictably, and is far easier to commission and maintain",
    img: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&q=80"
  },
  {
    icon: "🏅",
    title: "Advanced Signal Conditioning",
    desc: "Industrial sensors and transducers produce signals that need careful conditioning before they can drive reliable control decisions. AESPL's expertise in analog and digital signal conditioning ensures that the data your embedded system acts on is clean, accurate, and representative of what's actually happening in your process.",
    img: "https://images.unsplash.com/photo-1582719508461-905c673771fd?w=600&q=80"
  }
];

const problems = [
  { icon: "⚡", title: "Off-the-shelf modules fail in clinical settings", desc: "PLCs are designed to be programmable and flexible across many applications - which means they are rarely optimized for any one of them. For high-speed or precision industrial applications, that lack of optimization shows up in response latency, processing limitations, and integration friction" },
  { icon: "🎯", title: "Standard PLCs lack medical-grade precision", desc: "The licensing, programming environment, and proprietary protocols that PLC platforms require create ongoing dependency costs - in engineering time, in training, and in platform lock-in that limits your design freedom" },
  { icon: "📋", title: "Regulatory compliance is a design constraint", desc: "Industrial environments generate electrical noise that standard embedded platforms aren't hardened to handle. EMI, voltage spikes, and ground loops cause intermittent faults that are expensive to diagnose and impossible to reproduce in a lab." },
  { icon: "🔍", title: "Rare intersection of skills", desc: "At medium to high production volumes, the per-unit cost of a PLC-based control system becomes a significant margin issue. A custom embedded system, once developed, delivers dramatically lower unit costs - and that advantage only grows with volume" }
];

const trackItems = [
  "Custom machine controllers replacing PLC platforms for specific applications",
  "Real-time motor control - servo, stepper, and variable frequency drive integration",
  "Industrial process monitoring and closed-loop control systems",
  "Multi-axis machine sequencing and synchronization controllers",
  "Safety interlock and emergency shutdown embedded systems",
  "Industrial HMI panels and operator control stations",
  "Modbus, CAN, RS-485 and industrial communication protocol integration",
  "Production data logging, OEE monitoring, and MES integration modules",
];
  ...
  return (
    <div style={{ fontFamily: "'Satoshi', sans-serif", background: "#fff" }}>
      ...
      <div className="hero ">
        ...
        >
          Industrial Machines Don't Stop. {" "}
          <em style={{ fontStyle: "normal", color: "#b8c8f5" }}>Your Embedded Control System Shouldn't Either</em>
        </motion.h1>
        ...
        >
         AESPL designs custom embedded automation systems for industrial OEMs, built for precision, reliability, and continuous operation.
Our purpose-built systems perform reliably in harsh environments where generic control solutions fall short.
        </motion.p>
      ...
      <section className="problems">
        <FadeSection>
          ...
          <h2>Industrial OEMs Are Managing the Hidden Costs of Control Systems That Weren't Built for Their Application.</h2>
          <p className="section-desc">The industrial automation sector has relied on PLCs as the default control platform for decades - and for good reason. But for OEMs building specific machinery, PLCs increasingly represent a compromise that costs more than it saves</p>
        </FadeSection>
      ...
      <section className="solutions">
        <FadeSection>
          ...
          <h2>Embedded Automation Systems Designed for Industrial Reality — Not the Lab.</h2>
          <p className="section-desc">We engineer custom embedded controllers for industrial OEMs that are built to operate in the actual conditions your machine faces - high electrical noise, temperature variation, continuous duty, and the operator demands of a real production environment. Every design decision is made for field performance, not datasheet performance.</p>
        </FadeSection>
      ...
      <FadeSection>
        <div className="quote-band">
          <blockquote>
            "BARC — India's Bhabha Atomic Research Centre — trusted AESPL with embedded development for their critical applications. If our engineering standards are good enough for nuclear research, they're good enough for your production floor"
          </blockquote>
      ...
      <section className="cta-section-tf">
        <FadeSection>
          ...
          <h2>Your Industrial Machine Deserves a Control System Built for It.</h2>
          <p>Xray Luggage Scanner to add? ( security systems)
            <br />
            Bag filter cleaning system to add?
            <br />
            Operation theatre control Panel  to add?
            <br />
            Supplied compressor controller to Isro ( mention somewhere)
          </p>
